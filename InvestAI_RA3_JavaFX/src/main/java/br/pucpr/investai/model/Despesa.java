...
public class Despesa implements Identificavel, Validavel {
    ...
    public void validar() {
        ...
        if (descricao == null || descricao.isBlank()) throw new IllegalArgumentException("Descrição da despesa é obrigatória.");
        if (valor == null || valor.signum() <= 0) throw new IllegalArgumentException("Valor da despesa deve ser maior que zero.");
        if (dataDespesa == null) throw new IllegalArgumentException("Data da despesa é obrigatória.");
    }
}
