...
public class SugestaoEconomia implements Identificavel, Validavel {
    ...
    public void validar() {
        ...
        if (titulo == null || titulo.isBlank()) throw new IllegalArgumentException("Título da sugestão é obrigatório.");
        if (descricao == null || descricao.isBlank()) throw new IllegalArgumentException("Descrição da sugestão é obrigatória.");
